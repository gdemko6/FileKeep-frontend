  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://filekeep-backend-production.up.railway.app/signup",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition flex justify-center"
          disabled={isLoading}
        >
          {isLoading ? (
            <svg
